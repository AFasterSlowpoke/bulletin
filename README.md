The exact same thing as https://github.com/smoov22/bulletin , but it simply does nothing if an image is not found instead of raising an error! (remove everything from the booksonas folder to see it work!)
